...
const uint16_t PROGMEM cw_combo[] = {KC_SPC, OSM_LSFT, COMBO_END};
combo_t key_combos[] = {
    COMBO(cw_combo, OSM_RALT),
};
#endif
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    #ifdef DEDICATED_SHIFT
    [0] = LAYOUT_split_3x6_3_ex2(
        KC_LBRC, KC_Q,   KC_W,     KC_F,     KC_P,   KC_B,   KC_MPLY,  KC_SLEP, KC_J,    KC_L,     KC_U,    KC_Y,    KC_SCLN, KC_RBRC,
        KC_GRV,  HOME_A, HOME_R,   HOME_S,   HOME_T, KC_G,   MO(3),    MO(3),   KC_M,    HOME_N,   HOME_E,  HOME_I,  HOME_O,  KC_QUOT,
        KC_LPRN, KC_Z,   KC_X,     KC_C,     KC_D,   KC_V,                      KC_K,    KC_H,     KC_COMM, KC_DOT,  KC_SLSH, KC_RPRN,
